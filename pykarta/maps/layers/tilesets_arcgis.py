...
tilesets.append(MapTilesetRaster("arcgis-usa-topo",
	url_template="https://services.arcgisonline.com/ArcGIS/rest/services/USA_Topo_Maps/MapServer/tile/{z}/{y}/{x}",
	zoom_min=9,
	zoom_max=15,
...
tilesets.append(MapTilesetRaster("arcgis-world-reference-overlay",
	url_template="https://services.arcgisonline.com/ArcGIS/rest/services/Reference/World_Reference_Overlay/MapServer/tile/{z}/{y}/{x}",
	zoom_min=0,
	zoom_max=13,
	attribution="Esri, DigitalGlobe, GeoEye, i-cubed, USDA, USGS, AEX, Getmapping, Aerogrid, IGN, IGP, swisstopo, and the GIS User Community"
	))
...
tilesets.append(MapTilesetRaster("arcgis-delorme-world-basemap",
	url_template="https://services.arcgisonline.com/ArcGIS/rest/services/Specialty/DeLorme_World_Base_Map/MapServer/tile/{z}/{y}/{x}",
	zoom_min=1,
	zoom_max=11,
	))
